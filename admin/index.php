			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<ul class="navbar-nav mr-auto">
						...
						<!--<li class="<?php echo isset($pedidosMenu)?'active':''?> nav-item"><a class="nav-link" href="pedidos.php">Pedidos</a></li>-->
						<?php }?>
						...
						<?php }?>
						<li class="<?php echo isset($perfilMenu)?'active':''?> nav-item"><a class="nav-link" href="index.php?section=profiles">Perfiles</a></li>
