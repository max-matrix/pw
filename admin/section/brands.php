	...
	<div class="row justify-content-center">
		...
		<div class="col-12">
			<h2 class="sub-header text-left">
				<a href="index.php?section=brands_abm"><button type="button" class="btn btn-success btn-md"
						title="Agregar">Agregar Marca</button></a></h2>
					...
					<tr>
						...
						<td class="align-middle">
							<div class="col-12">
								<div class="row justify-content-center">
									<form
										action="index.php?section=brands_abm&edit=<?php echo $marca['id_marca']?>"
