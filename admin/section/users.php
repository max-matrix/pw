    ...
    <div class="col-12">
      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            <td class="font-weight-bold align-middle"><?php echo $usuario['id_usuario'];?>
            </td>
            <td class="align-middle"><?php echo $usuario['nombre'];?>
            </td>
            <td class="align-middle"><?php echo $usuario['apellido'];?>
            </td>
            <td class="align-middle"><?php echo $usuario['usuario'];?>
            </td>
            <td class="align-middle"><?php echo $usuario['email'];?>
            </td>
            <td class="align-middle"><?php echo isset($usuario['perfiles'])?implode(', ', $usuario['perfiles']):'No tiene perfiles asignados';?>
            </td>
            <td class="align-middle"><?php echo ($usuario['activo'])?'si':'no';?>
            </td>
            <td class="align-middle">
              ...
              <div class="col-12">
                                    <div class="row justify-content-center">
                                        ...
                                        <form action="index.php?section=users&del=<?php echo $usuario['id_usuario']?>" method="POST" class="delete mr-2">
