    ...
    <h1 class="page-header">
        <? echo $titulo ?>
            ...
            <div class="col-md-2"></div>
                ...
                <form action="index.php?section=users" method="post" class="col-md-6 from-horizontal">

                    <div class="form-group">
                        <label for="nombre" class="col-sm-2 control-label">Nombre</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nombre" name="nombre" placeholder="" value="<?php echo isset($usuarios->nombre)?$usuarios->nombre:'';?>">
                        </div>
                    </div> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="apellido" name="apellido" placeholder="" value="<?php echo isset($usuarios->apellido)?$usuarios->apellido:'';?>">
                        </div>
                    </div> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="usuario" name="usuario" placeholder="" value="<?php echo isset($usuarios->usuario)?$usuarios->usuario:'';?>">
                        </div>
                    </div> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="email" class="form-control" id="email" name="email" placeholder="" value="<?php echo isset($usuarios->email)?$usuarios->email:'';?>">
                        </div>
                    </div> 
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" class="btn btn-warning" name="formulario_usuarios" >Guardar Usuario</button>
                        </div>
                    </div> 
