  ...
  <div class="row justify-content-center">
    ...
    <div class="col-12">
      <h2 class="sub-header text-left">
        <a href="index.php?section=categories_abm"><button type="button" class="btn btn-success btn-md"
            title="Agregar">Agregar Categoría</button></a></h2>
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            <td class="align-middle"><?php echo $categoria['id_categoria'];?>
            </td>
            <td class="align-middle"><?php echo $categoria['nombre'];?>
            </td>
            <td class="align-middle"><?php echo $categoria['padre'];?>
            </td>
            <td class="align-middle"><?php echo ($categoria['activo'])?'si':'no';?>
            </td>
            <td class="align-middle">
              <div class="col-12">
                <div class="row justify-content-center">
                  <form
                    action="index.php?section=categories_abm&edit=<?php echo $categoria['id_categoria']?>"
                    method="POST" class="modify mr-2">
                    <button type="submit" class="btn btn-info btn-sm" title="Modificar"><i
                        class="fas fa-edit"></i></button>
                  </form>
                  <form
                    action="index.php?section=categories&del=<?php echo $categoria['id_categoria']?>"
