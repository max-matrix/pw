...
<div class="container-fluid">
	...
	<div class="col-sm-9 col-md-10 main">
		...
		<h2 class="sub-header">Listado <a href="marcas_abm.php"><button type="button" class="btn btn-success btn-lg" title="Agregar">Agregar</button></a></h2>
		...
		<div class="table-responsive">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						<td><?php echo $marca['id_marca'];?>
						</td>
						<td><?php echo $marca['nom_marca'];?>
						</td>
						<td>
							<a	href="marcas_abm.php?edit=<?php echo $marca['id_marca']?>"><button
								type="button" class="btn btn-info btn-lg" title="Modificar">Modificar</button></a>
							
							<a	href="marcas.php?del=<?php echo $marca['id_marca']?>"><button
