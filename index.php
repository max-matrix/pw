				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav mr-auto">
						<?php
                            ...
                            ?>
						<li
							class="nav-item <?= $section == strtolower($navname) ? "active" : "" ?> ">
							<a class="nav-link"
								href="<?php echo $link; ?>"><?php echo $navname; ?></a>
						</li>
						<?php
                            endforeach;
                            ?>
					...
					<ul class="navbar-nav mt-2 mt-lg-0 col-4 justify-content-end">
						<?php
                            ...
                            ?>
						<li class="nav-item">
							<span class="navbar-text font-weight-bold">Hola <?= strtoupper($_SESSION["usuario"]["usuario"]); ?>
								- </span>
						</li>
						<li class="nav-item">
					...
					<form class="form-inline my-2 my-lg-0">
						<input class="form-control mr-sm-2" type="search" placeholder="¿Qué desea buscar?"
							aria-label="Search">
